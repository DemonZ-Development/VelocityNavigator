...
public final class PrometheusExporter {
    ...
    private class MetricsHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            Map<String, CircuitBreakerState> cbStatuses = plugin.getCircuitBreakerStatuses();
            ...
            for (String serverName : trackedServers) {
                ...
                CircuitBreakerState state = cbStatuses.getOrDefault(serverName,
                        cbStatuses.getOrDefault(lowerName, CircuitBreakerState.CLOSED));
    ...
    public static boolean isLoopbackBindHost(String bindHost) {
    ...
    public static boolean shouldReportServerOnline(boolean healthFilteringDisabled, boolean tracked, boolean cachedOnline) {
