...
public final class DashboardServer {
    ...
    public static boolean isAuthorized(String bearerToken, HttpExchange exchange) {
        if (bearerToken == null || bearerToken.isBlank()) {
            return true;
        }
        String header = exchange.getRequestHeaders().getFirst("Authorization");
        return header != null && header.startsWith("Bearer ")
                && constantTimeEquals(bearerToken, header.substring(7).trim());
    }
    ...
    private Map<String, Object> buildState() {
        ...
        Map<String, CircuitBreakerState> breakerStates = plugin.circuitBreaker() == null
                ? Map.of()
        ...
        for (String name : tracked) {
            ...
            CircuitBreakerState cb = breakerStates.get(name.toLowerCase(Locale.ROOT));
    ...
    public static Set<String> trackedServers(Config config, Set<String> dynamicLobbies) {
